...
app.post('/ask', async (req, res) => {
  try {
    ...
    console.log("The qustion is: ",question)
    ...
    const chat = await groq.chat.completions.create({
      ...
      messages: [
        { role: "system", content: "You are a helpful assistant. Use the provided context to answer the user’s question concisely. Do not just repeat the context, summarize it into a clear answer. If the answer is not in the context, reply with 'I don’t know'." },
